...
def save_game_result():
    try:
        ...
        if result:
            ...
            # Суммируем NFT
            total_nft = float(current_nft) + nft_collected
            ...
            referral_count = 0
            cursor.execute(''' 
                INSERT INTO users (user_id, username, best_time, total_nft, referral_count, last_updated)
                VALUES (%s, %s, %s, %s, %s, %s)
            ''', (user_id, username, best_time, total_nft, referral_count, datetime.now()))
